    ...
    [{tag: ['img', 'i', 'a', 'div'],
     ...
     {tag: 'div',
      "class": [['*', 'share-button'], 'metro-social', 'share24', 'social', 'share-links', 'article-share-bar',
                ...
                'social-button-small', ['*', 'social-button'], 'social-bar', 'flare-total',
                'flare-buttons', 'flare-total', ['^', 'flare countloaded'],
                ...
                ['*', 'layout--share'], ['*', 'share__'], 'share-header', 'sharebar-outer',
                'sharebar-inner', 'sharebar-share', 'sharebar-like', 'social-action', 
